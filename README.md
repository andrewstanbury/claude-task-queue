...
|---|---|---|---|
| **task-queue** | 0.29.0 | Orchestrate | review loop on every prompt (steelman→challenge critique) · wireframe design preview · intent→outcome gate · open-questions tracker · cross-session resume |
...
| **hud** | 0.7.1 | Show | one read-only status line — health · tests · open-Qs · context % · session-cost · branch (+unpushed) · model |
