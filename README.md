...
| **hud** | 0.20.6 | Show — one read-only status line (health, always-on 🛡 safety shield, ✅/❌ tests, 🎨/🔒 edit gates, feature state as bare icons, ❓ decisions + ⏳ owner-blocked, tokens, project + branch) |
