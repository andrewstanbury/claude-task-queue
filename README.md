...
| **hud** | 0.21.0 | Show — one read-only status line (health, always-on 🛡 safety shield, ✅/❌ tests, 🎨/🔒 edit gates, feature state as bare icons, ☐ open tasks + ▸ current, ❓ decisions + ⏳ owner-blocked, tokens, project + branch) |
