...
| **hud** | 0.15.0 | Show | one read-only status line — health · always-on feature status (✈️ autopilot/🤖 agents/🧷 logs, green on/grey off) · model · tests · floors-off · open-Qs · tok · branch (+unpushed) (`/hud:legend` decodes every symbol) |
