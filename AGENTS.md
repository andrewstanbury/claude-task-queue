...
plugins/companion/
  ...
  commands/{setup,autopilot,ship-it,resume,review,advise,regen,redesign,document,features}.md  # advise=critique; regen/redesign=contract-preserving rebuilds (R54/R55)
