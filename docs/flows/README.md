...
(recommend → scaffold flow tests) · `/companion:board` (visual queue board: typed lanes, done as a
real list, deps + rec: legible; plus what burn-down's provenance rank would propose beyond the
queue, read-only — R98).
